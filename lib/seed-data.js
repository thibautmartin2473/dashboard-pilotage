...
export const PROJECTS = [
  ...
  },
  {
    slug: 'spircle',
    name: 'Spircle',
    repo_path_local: 'C:\\Users\\thiba\\OneDrive\\Desktop\\Spircle\\bar-finder',
    repos: [
      { kind: 'vercel', ref: 'prj_nHk86VR041gCbXW9J8VcBUIEThup', label: 'bar-finder (app mobile)' },
      { kind: 'vercel', ref: 'prj_gC2UWuiirrDYDg07HYR1oZPMjoF9', label: 'bar-finder-admin' },
      { kind: 'vercel', ref: 'prj_GqUC46iCaCsOs1e0vS4OrzxSoCzS', label: 'bar-finder-owner' },
      { kind: 'vercel', ref: 'prj_i7mahHxmOukWHwfNSaCJs1m9QL2y', label: 'bar-finder-portal' },
    ],
    milestones: [
      ...
      { label: 'Espace propriétaire de bar (bar-finder-owner)', status: 'in_progress' },
      { label: 'Portail public (bar-finder-portal)', status: 'todo' },
      { label: 'Dépôts poussés sur GitHub', status: 'todo' },
