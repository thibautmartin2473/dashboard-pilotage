...
export async function loadHomePanels() {
  const [tasks, suggestions, ideas, events, mails, apps, settings, notifications] = await Promise.all([
  ...
  return { tasks, suggestions, ideas, events, mails, apps, settings, notifications };
}
